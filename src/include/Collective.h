...
public:
  ...
  void read_particles_restart(const VCtopology3D *vct, int species_number,
                              ...
                              vector_double &z, vector_double &t) const;
  ...
  // bool getTrackParticleID(int nspecies)const{ return
  // (TrackParticleID[nspecies]); }
  ...
  string getGMMDirName() const { return (GMMDirName); }
